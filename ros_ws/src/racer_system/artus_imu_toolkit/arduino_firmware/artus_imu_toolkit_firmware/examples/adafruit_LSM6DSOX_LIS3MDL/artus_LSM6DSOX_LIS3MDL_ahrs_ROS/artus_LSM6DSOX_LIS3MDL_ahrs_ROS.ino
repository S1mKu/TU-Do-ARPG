/*!
 * @file        artus_LSM6DSOX_LIS3MDL_ahrs_ROS.ino
...
///~~~~~~~~ Quaternions ~~~~~~~~~~~~~~~~~~~~~~~//
    SerialPort.print(String(imuValues.quaternion.qx, 5) + "," + String(imuValues.quaternion.qy, 5) + "," +
                     String(imuValues.quaternion.qz, 5) + "," + String(imuValues.quaternion.qw, 5));
///~~~~~~~~ Linear Acceleration ~~~~~~~~~~~~~~~//
    SerialPort.print("," + String(imuValues.linAcc.x, 5) + "," + String(imuValues.linAcc.y, 5) + "," +
                     String(imuValues.linAcc.z, 5));
///~~~~~~~~ Angular Velocity ~~~~~~~~~~~~~~~~~~//
    SerialPort.print("," + String(imuValues.angVel.x, 5) + "," + String(imuValues.angVel.y, 5) + "," +
                     String(imuValues.angVel.z, 5));
///~~~~~~~~ relativ Velocity ~~~~~~~~~~~~~~~~~~//
    SerialPort.print("," + String(imuValues.relVelocity.x, 5) + "," + String(imuValues.relVelocity.y, 5) + "," +
                     String(imuValues.relVelocity.z, 5));
///~~~~~~~~ relativ Distance ~~~~~~~~~~~~~~~~~//
    SerialPort.println("," + String(imuValues.relDistance.x, 5) + "," + String(imuValues.relDistance.y, 5) + "," +
                       String(imuValues.relDistance.z, 5));
///~~~~~~~~ Header ~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
#endif
}