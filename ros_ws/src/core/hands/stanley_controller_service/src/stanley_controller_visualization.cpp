...
StanleyControllerVisualization::StanleyControllerVisualization(ros::NodeHandle& nh):
    node_handle_(nh) {
    loadParameter();
    setupPublisher();
}

void StanleyControllerVisualization::loadParameter() {
...
void StanleyControllerVisualization::setupPublisher() {
...
void StanleyControllerVisualization::visualize(geometry_msgs::PolygonStamped polygon, const geometry_msgs::Point32 point) { 
    followed_path(polygon);
    look_ahead(point);
}

void StanleyControllerVisualization::followed_path(geometry_msgs::PolygonStamped polygon) {
    nav_msgs::Path path;
...
void StanleyControllerVisualization::look_ahead(const geometry_msgs::Point32 point) {
